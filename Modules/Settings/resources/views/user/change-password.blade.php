    ...
    <div class="col-md-12 p-0">
        <div class="card rounded-0 mb-4">
            ...
            <div class="card-body">
                ...
                <form autocomplete="off" action="{{ route($data['prefix_route'].'updatePassword', ['field_data' => $data['field_data']->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row pt-2 pb-2 px-2">
                        <div class="col-md-12 col-lg-12 ml-auto text-end">
                            <a href="{{ route($data['prefix_route'].'index') }}" class="btn btn-danger">
