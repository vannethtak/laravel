        ...
        <li>
            <div class="pretty p-svg p-plain p-bigger p-smooth">
                ...
                <div class="state">
                    ...
                    <label class="" for="module_{{ $module['id'] }}">
                        {{ $module['name'] }}
                    </label>
                </div>
            </div>
                    ...
                    <li>
                        ...
                        <ul>
                            @foreach ($data['pageAction'] as $pageAction)
                                ...
                                <li>
                                    <div class="pretty p-svg p-plain p-bigger p-smooth">
                                        <input id="page_{{ $pageAction['id'] }}" value="{{ $pageAction['id'] }}" name="action_id[]" type="checkbox" class="form-check-input">
                                        <div class="state">
                                            <img class="svg" src="{{ custom_asset('image/check-circle.svg') }}"/>
                                            <label for="page_{{ $pageAction['id'] }}">
                                                {{ $pageAction['name'] }}
                                            </label>
                                        </div>
                                    </div>
